...
call %cwd%\install\windows\tools\removeCR.bat %cwd%\server\out\processing\insightscontainer\insightlist.txt

dir /B %cwd%\server\out\processing\custom > %cwd%\server\out\processing\customcontainer\custom.txt
call %cwd%\install\windows\tools\removeCR.bat %cwd%\server\out\processing\customcontainer\custom.txt

dir /B %cwd%\server\out\processing\extractor\processing\core > %cwd%\server\out\processing\container\core.txt
call %cwd%\install\windows\tools\removeCR.bat %cwd%\server\out\processing\container\core.txt

dir /B %cwd%\server\out\processing\extractor\processing\awt > %cwd%\server\out\processing\container\awt.txt
call %cwd%\install\windows\tools\removeCR.bat %cwd%\server\out\processing\container\awt.txt

dir /B %cwd%\server\out\processing\extractor\processing\data> %cwd%\server\out\processing\container\data.txt
call %cwd%\install\windows\tools\removeCR.bat %cwd%\server\out\processing\container\data.txt

dir /B %cwd%\server\out\processing\extractor\processing\event > %cwd%\server\out\processing\container\event.txt
call %cwd%\install\windows\tools\removeCR.bat %cwd%\server\out\processing\container\event.txt

dir /B %cwd%\server\out\processing\extractor\processing\javafx > %cwd%\server\out\processing\container\javafx.txt
call %cwd%\install\windows\tools\removeCR.bat %cwd%\server\out\processing\container\javafx.txt

dir /B %cwd%\server\out\processing\extractor\processing\opengl > %cwd%\server\out\processing\container\opengl.txt
call %cwd%\install\windows\tools\removeCR.bat %cwd%\server\out\processing\container\opengl.txt
